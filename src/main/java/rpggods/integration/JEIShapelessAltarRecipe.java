...
public class JEIShapelessAltarRecipe {

    public static final class Wrapper extends CraftingCategoryExtension<ShapelessAltarRecipe> {

        public Wrapper(ShapelessAltarRecipe recipe) {
            super(recipe);
        }
