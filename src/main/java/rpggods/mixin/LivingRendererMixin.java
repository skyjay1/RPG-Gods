...
public class LivingRendererMixin {
    ...
    @ModifyVariable(
            ...
            index=7)
    private boolean shouldSit(boolean shouldSit, LivingEntity entity, float entityYaw, float partialTicks, MatrixStack matrixStack, IRenderTypeBuffer buffer, int packedLight) {
